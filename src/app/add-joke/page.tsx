                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <SelectContent>
                                <SelectItem value="googleai/gemini-2.0-flash">Gemini 2.0 Flash (Fast)</SelectItem>
                                <SelectItem value="googleai/gemini-1.5-pro">Gemini 1.5 Pro (Powerful)</SelectItem>
                            </SelectContent>
                            </Select>
                        </div>
                        <div>
