...
export default function EditJokePage() {
   ...
   if (loadingJokeData || loadingCategories) {
        ...
        return (
            <div className="container mx-auto px-4 py-8 sm:px-6 md:py-12">
                 ...
                 <Card className="max-w-2xl mx-auto">
                    <CardHeader> <CardTitle as="h2" className="text-error">Error</CardTitle> </CardHeader>
                    <CardContent>
    ...
    if (!joke) {
         return (
            <div className="container mx-auto px-4 py-8 sm:px-6 md:py-12">
                 <Header title="Edit Joke" />
                 <Card className="max-w-2xl mx-auto"> <CardHeader><CardTitle as="h2">Joke Not Editable</CardTitle></CardHeader>
                    <CardContent>
  ...
  return (
    <div className="container mx-auto px-4 py-8 sm:px-6 md:py-12">
      ...
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          <CardTitle as="h2">Update Joke Details</CardTitle>
